import { Box, Stack, Typography,  Button, Select, MenuItem,InputLabel, FormControl } from '@mui/material'
...
function Profile() {
  ...
  return (
    <Box padding={4}>
        ...
        <Box boxShadow={"0px 0px 2px rgba(0, 0, 0, 0.25)"} p={4} sx={{backgroundColor: theme.palette.mode=='light'? "#F8FAFF": "black", boxShadow: "0px 0px 2px rgba(0, 0, 0, 0.25)" }}margin={4}>
